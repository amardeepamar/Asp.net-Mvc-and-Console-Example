...
namespace App1
{
    public class HomeController: Controller
    {
        ...
        //Get: home/CreateViewExample
        public ViewResult CreateViewExample()
        {
            return View();
        }
        //Get: home/ViewNameExample
        public ViewResult ViewNameExample()
        {
            return View("Welcome");
        }
        //Get: home/RazorCodeBlocksExample
        public ActionResult RazorCodeBlocksExample()
        {
            return View();
        }
