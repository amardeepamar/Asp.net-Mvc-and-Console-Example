...
namespace UnionExample
{
    ...
    public class AmarDbContext : DbContext
    {
        public AmarDbContext() : base(@"data source=DESKTOP-IS2M88R;integrated security=yes;initial catalog=company")
        {
    ...
    class Program
    {
        static void Main()
        {
            AmarDbContext db = new AmarDbContext();
